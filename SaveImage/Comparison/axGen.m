function axGen(data,name,label,pos,y)
%Axis is Generation
    X = 1 : size(data,2);
    ...
    axis square;
    exportgraphics(gcf,[name,y,'Gen.pdf'],'BackgroundColor','none','ContentType','vector');
    exportgraphics(gcf,[name,y,'Gen.emf'],'BackgroundColor','none','ContentType','vector');
    savefig([name,'Gen.fig']);
    close;
end
